...
def breadthFirstSearch(problem):
    ...
    while not frontier.isEmpty():
        ...
        if state not in exploredSet:
            ...
            for successor, action, cost in sorted(problem.getSuccessors(state)):
                newPath = path + [action]
                if problem.isGoalState(successor): 
                    return newPath
                if successor not in exploredSet and successor not in frontierSet:
    ...
    while not frontier.isEmpty():
        ...
        if currentState not in exploredSet:
            ...
            for successor, action, cost in problem.getSuccessors(currentState):
                if successor not in exploredSet and successor not in [s for s, _ in frontier.list]:
        ...
        if currentState not in exploredSet:
            ...
            for successor, action, cost in problem.getSuccessors(currentState):
                if successor not in exploredSet:
                    newPath = path + [action]
                    frontier.push((successor, newPath), heuristic(successor, problem))
